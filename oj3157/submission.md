...
```text
โจทย์ให้เพิ่มค่าลดค่าตามอินที่ใส่ไป
Input:บรรทัดแรก จำนวนเต็ม1จำนวน
บรรทัด2ถึง n ใส่+/- 
Output:ค่าที่ได้หลัง +/- 
Constraints:inputบรรทัดแรกต้องเป็น int เพราะต้องลูป
```
...
```text
1:รับค่าเลขเต็ม
2:ลูปรับค่าตามจำนวนเลขอินพุตแรก
3:เพิ่มหรือลดค่าตามเครื่องหมายที่รับในแต่ละลูป
4:แสดงผลหลังลูปเสร็จ
```
...
```text
เหมือนแผนแรก ใช้ลูปรับค่าแล้วเพิ่มลดค่า แล้วแสดงผล
```
...
```text
เชคว่า outputเป็นค่าที่เพิ่มขึ้นจริงไหม
```
...
```text
เชคว่า output มีการสะสมเพิ่มไหม
```
