...
```text
ให้รับค่าจำนวนคนในวง จำนวนคนที่จะข้ามรอบนึง ตำแหน่งขโมย แล้วหาว่ามีคนเชคของไปกี่คนตอนหยุดพอดี
Input:รับค่าจำนวนเต็ม3ตัว
Output:จำนวนคนที่เชคของขวัญ
Constraints:อินพุตต้องเป็นจำนวนเต็ม
```
...
```text
1:รับอินพุตจำนวนเต็ม3ตัว
2:สร้างตัวแปร2ตัว ตัวแรกมีค่า1 ตัวสอง0เพื่อใช้ในวายลูป
3:ใช้วายลูปแล้วเพิ่มค่าตัวแปรสองทุกครั้งเพื่อเป็ยการนับจำนวนคนเชคของ
4:ถ้าตัวแปรแรกเท่ากับtแปลว่าคนแรกเป็นขโมยให้หยุดลูปทันที
5:เอาค่าตัวแปรแรกบวกจำนวนคนที่ต้องผ่านลบหนึ่งแล้วมอดด้วยจำนวนคนทั้งหมดบวกหนึ่ง เพื่อรู้ตำแหน่งคนถัดไปที่เชคแล้วแทนค่าในตัวแปรแรก
6:ถ้าตัวแปรแรกเท่ากับหนึ่งให้หยุดเพราะมันกลับมาคนที่เคยเชคแล้ว
7:แสดงจำนวนครั้งที่ลูป เพราะจำนวนลูปเท่ากับจำนวนคนที่เชค
```
...
```text
เหมือนแผนแรก ใช้การลูปแบบเพิ่มค่าทุกครั้งที่ลูปจนกว่าหยุดลูปเพื่อหาจำนวนครั้งของลูปเพราะจำนวนครั้งลูป=จำนวนคนที่เชค
```
...
```text
เชคว่าลูปหยุดตอนโดนคนแรกอีกทีไหม
```
...
```text
เชคว่าโจรเป็นคนแรกแล้วหยุดเลยไหม
```
