...
```text
https://ijudge.it.kmitl.ac.th/submissions/562276/overview
```
...
```text
โตทย์ให้รับค่าเลขมาแล้วหาว่าเลขนั้นต้องผ่านห้องกี่ครั้งเพื่อไปให้ถึงห้องของเลข1
Input:รับค่าจำนวนเต็มn
Output:จำนวนห้องที่ผ่านทั้งหมดเพื่อไปห้องเลข1
Constraints:อินพุตเป็น1ควรแสดง0เลยเพราะอยู่ในห้องนั้นแล้ว
```
...
```text
1:รับค่าจำนวนเต็มn
2:เชคว่าnเท่ากับ1ไหม ถ้าใช่แสดงผล0
3:กำหนดค่า3ค่า
left(ขอบซ้าย)=2
right(ขอบขวา)=4
plus(ผลต่างระหว่างชั้นขอบขวาชั้นบนกับขอบซ้ายชั้นล่าง[เฉพาะชั้นที่ติดกัน])=1
4:ใช้วายลูปเชคว่าnน้อยกว่าขอบขวารึยัง(ถ้าน้อยกว่าขอบขวาแสดงว่าเจอชั้นที่ n อยู่แล้ว)
5:เพิ่มค่าทุกครั้งที่เริ่มลูป
plusเพิ่มขึ้น2
left บวกค่า plusใหม่เพิ่ม(จะรู้ขอบซ้ายชั้นใหม่)
right บวกค่า plusใหม่ที่บวก2อีก (ได้ขอบขวาชั้นใหม่)
6:ถ้าrightหาร2แล้วเศษได้0ให้เข้าเงื่อนไขต่อมา
ถ้าnหาร2แล้วได้เศษ0 ให้แสดงค่า plus +1
ถ้าnหาร2ไม่ได้เศษ0 ให้แสดงค่า plus
!เพราะถ้า n เป็นคู่/คี่เหมือนเลขขอบ จำนวนห้องที่ผ่านจะมีค่าเท่ากับ plus+1 แต่ถ้าเป็นเลขต่างประเภทกันจะมีค่าเท่ากับ plus!
7:ถ้าrightหาร2แล้วเศษไม่ได้0ให้เข้าเงื่อนไขต่อมา
ถ้าnหาร2แล้วได้เศษ0 ให้แสดงค่า plus
ถ้าnหาร2ไม่ได้เศษ0 ให้แสดงค่า plus+1
```
...
```text
เหมือน ใช้ modหาเลขคู่/คู่ของค่า n กับ right(ขอบขวา) เพื่อจะได้รู้ว่าเหมือนกันไหม ถ้าเหมือนแสดงค่า plus+1 ไม่เหมือนแสดงค่า plus เพราะจำนวนห้องที่ต้องผ่านมีค่าเท่ากับค่า plus/plus+1
...
```text
เพราะค่า n เป็นคนละประเภทกับขอบ มันควรจะได้ค่า plus
```
...
```text
เพราะค่า n เป็นประเภทเดียวกับขอบ มันควรจะได้ค่า plus+1
```
