...
```text
โจทย์ให้รับค่าข้อความยาว5อักขระ แล้วเอาอักขระท้ายสุดมาไว้หน้าสุด แล้วกลับหลังอักขระที่เหลือและทั้งหมดเป็นตัวพิมพ์เล็ก
Input:รับค่า str 5อักขระ
Output:อักขระทั้งหมดต้องสลับตำแหน่งกลับหลังและเป็นพิมพ์เล็ก
Constraints:inputควรรับได้แค่5อักขระ
```
...
```text
1:สร้างตัวแปรรับค่าอักขระ5ตัว
2:สร้างตัวแปรใหม่ที่่่่มีค่าเป็นตัวแปรอินพุตกลับหลัง
3:แสดงผลตัวแปรใหม่เป็นพิมพ์เล็ก
```
...
```text
เหมือน รับค่ามาแล้วเอามากลับด้านแล้วแสดงผลแบบพิมพ์เล็ก
```
...
```text
พิมพ์เล็กเป็นพิมพ์เล็กเหมือนเดิม
```
