...
```text
โจทย์ให้รับค่าเลขมาสองตัว แล้วหาจำนวนเฉพาะจากเลขแรกถึงเลขสองว่ามีกี่จำนวนและจำนวนนั้นคือเลขไร
Input:รับเลข2ตัวบรรทัดเดียวกัน
Output:แสดงจำนวนของจำนวนเฉพาะที่มีในช่วง และเลขจำนวนเฉพาะนั้น
Constraints:ควรเก็บจำนวนเฉพาะในลิส เพื่อที่จะได้ดึงออกมาแสดงได้ง่าย
```
...
1:รับอินพุตสองตัว
2:สร้างลิสว่าง
3:ลูปเริ่มจากอินพุตตัวแรกถึงตัวสอง
ถ้า iน้อยกว่า2ให้ไปเลย 
4:ลูปสูตรเชคจำนวนเฉพาะถ้าpจริงให้ใส่ในลิส ถ้าไม่ให้หยุด
5:ถ้าในลิสมีสมาชิกมมากกว่า0ให้แสดงสมาชิกในลิส
6:แสดงจำนวนสมาชิกในลิส
```
...
```text
เหมือนแผนแรก ใช้ลิสเก็บข้อมูลที่ต้องการอย่างจำนวนเฉพาะ แล้วใช้ if-elseเชคจำนวนในลิส เพื่อแสดงค่า
```
...
```text
เชคว่าถ้าไม่มีสมาชิกในลิสจะไม่ผลสมาชิกในลิส
```
...
```text
เชคว่าต้องไม่มี1เพราะ1ไม่ใช่จำนวนเฉพาะ
```
