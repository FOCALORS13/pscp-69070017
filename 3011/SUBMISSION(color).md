...
```text
โจทย์ให้รับค่าสีมา ถ้าตรงตาามแม่สี3สี ให้เอาสีที่ได้มาทั้งสองอันมาผสมได้สีไรหรือไม่ตรงแม่สีปริ้นเออเร่อ
Input:รับค่าสองค่า
Output:พิมสีที่ผสมได้ถ้าเสียงรับค่าตรงสีที่กำหนด หรือพิมเออเร่อถ้าไม่ตรงกับที่กำหนด
Constraints:
```
จากโจทย์บอกว่าให้ผสมสีกัน เลยคิดว่าถ้าสีเดียวกันแล้วตรงแม่สีเลยน่าจะต้องให้พิมสีนั้นด้วย 
---
...
```text
Step 1:รับค่าข้อความ2ค่า
Step 2:สร้างลิสแม่สี
Step 3:เช็คเงื่อนไขสีที่ตรงแล้วปริ้นสีที่ผสมได้
Step 4:ถ้าไม่ตรงให้พิมเออเร่อ
```
