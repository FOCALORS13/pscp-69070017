...
```text
https://ijudge.it.kmitl.ac.th/submissions/560331/overview
```
...
```text
ให้หาว่าบ้านคนที่ตำแหน่ง x , y จะโดนหมึกตอนไหน 
Input:รับค่าพื้นที่แผ่ขยายของหมึก1วิ
กับจำนวนคำร้องขอ
Output:เวลาที่นํ้าหมึกมาถึงตำแหน่งบ้านของคนร้องขอที่ i
Constraints:อิมพอตแมทมาเพื่อใช้หารปัดเศษขึ้น
```
...
```text
1:ใช้วายลูปวนลูปรับค่าตำแหน่งบ้านจนกว่าจะครบ b ครั้ง
2:สร้างตัวแปรหาค่ารัศมีกำลังสองของบ้านคนร้อง
3:คำนวณเวลาโดยใช้คำสั่งจากอิมพอตแมต หารปัดขึ้นมาใช้
4:แสดงค่าเวลาที่โดน
```
...
```text
เหมือนแผนแรก หาพื้นที่บ้านคนร้องเป็นพื้นที่วงกลมก่อนแล้วค่อยหารปัดเศษขึ้นกับพื้นที่หมึก เพื่อหาเวลา
```
