...
```text
https://ijudge.it.kmitl.ac.th/submissions/562204/overview
```
...
```text
โจทย์หาค่าที่หาร10ลงตัว จากช่วงเลขที่รับค่ามาถึง0
Input: รับค่าตัวเลขหนึ่งตัว
Output: พิมเลขที่หาร10ลงตัวออกมาในบรรทัดเดียวกันแบบเว้นวรรค
Constraints:รับค่าเป็น int
```
...
```text
1:รับค่าเลขa
2:ใข้วายลูปวนจนกว่าaน้อยกว่า0
3:เชคว่าaหารสิบลงตัวไหม ถ้าใช่ปริ้นค่า a 
4:ลดค่าaทีละ1เพื่อลูปค่าต่อไป
...
```text
เหมือน ใช้การหารมอดเอาเศษเพื่อเชคว่าได้0ไหม ถ้าได้คือหารลงตัว
```
...
```text
เพื่อเชคว่าจะได้แค่เลขที่หาร10ลงตัว
```
...
```text
เชคว่าถ้าเลขแรกหารลงตัวจะแสดงเลขแรกไหม
```
